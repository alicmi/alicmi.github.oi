...
// Placeholder for your future GitHub URL. 
// For now, it points to the local 'images/' folder relative to index.html.
// When you upload to GitHub, you can change this to: 
// "https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_REPO/main/public/images/"
...
export const PROJECTS: Project[] = [
    { 
        ...
        img: `${IMG_PATH}re-KISD1.jpg`,
        secondaryImg: `${IMG_PATH}refindingKISDposter.png`, 
    ...
    { 
        ...
        img: `${IMG_PATH}English-Quest-examples-Real-Life-Quest.png`,
        secondaryImg: `${IMG_PATH}Real-life-quest-Layout-App.png`,
    ...
    { 
        ...
        img: `${IMG_PATH}Postcards_Chaos_front1.png`,
        secondaryImg: `${IMG_PATH}Postcards_Chaos_back.png`,
        secondaryImg: `${IMG_PATH}Postcards_Chaos_front2.png`,
        secondaryImg: `${IMG_PATH}Postcards_Chaos_front3.png`,
    ...
    { 
        ...
        img: `${IMG_PATH}CoHeat-Thermostat-Rendering.png`,
    ...
    { 
        ...
        img: `${IMG_PATH}lebendiges-köln-Philosophie.png`,
